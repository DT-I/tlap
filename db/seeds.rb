...
Resource.create!([
  {name: "Children At Risk", url: "childrenatrisk.org", description: "An organization that provides support resources for children at risk.", resource_category_id: nil},
