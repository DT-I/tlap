...
class QuestionnairesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create questionnaire" do
    assert_difference('Questionnaire.count') do
      post questionnaires_url, params: { questionnaire: { QuestionName: @questionnaire.QuestionName, QuestionSlug: @questionnaire.QuestionSlug } }
    end
  ...
  test "should update questionnaire" do
    patch questionnaire_url(@questionnaire), params: { questionnaire: { QuestionName: @questionnaire.QuestionName, QuestionSlug: @questionnaire.QuestionSlug } }
